...
(function(exports) {
  ...
  var UpdateTitle = (function () {
      function UpdateTitle(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateTitle.create = function (value0) {
          return function (value1) {
              return new UpdateTitle(value0, value1);
          };
      };
      return UpdateTitle;
  })();
  ...
  var item = function (initialState) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Remove) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(NotifyRemove.value))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
...
(function(exports) {
  ...
  var Halogen_HTML_Events = PS["Halogen.HTML.Events"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Item_Component = PS["Item.Component"];
  var Item_Model = PS["Item.Model"];
  ...
  var HandleItemMessage = (function () {
      ...
      HandleItemMessage.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new HandleItemMessage(value0, value1, value2);
              };
          };
      };
  ...
  var ordItemSlot = new Data_Ord.Ord(function () {
      return eqItemSlot;
  }, function (x) {
      return function (y) {
  ...
  var component = (function () {
      ...
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Item list") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(NewItem.create)) ])([ Halogen_HTML_Core.text("New Item") ]) ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderItem)(st.items)) ]);
      };
      var $$eval = function (v) {
          if (v instanceof NewItem) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(addItem))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          ...
          throw new Error("Failed pattern match at ItemList.Component line 62, column 3 - line 62, column 72: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(ordItemSlot)({
          initialState: Data_Function["const"](ItemList_Model.initialItemList),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  ...
  exports["HandleItemMessage"] = HandleItemMessage;
  exports["component"] = component;
...
(function(exports) {
  ...
  var Halogen_Query = PS["Halogen.Query"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var ItemList_Component = PS["ItemList.Component"];
  var Prelude = PS["Prelude"];        
  var Slot = (function () {
      function Slot() {
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid))))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Halogen_Query.request(ComponentB_Component.GetCount.create)))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid))))(Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Halogen_Query.request(ComponentC_Component.GetValue.create)))(function (v2) {
