...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Component A") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(ItemList_Component.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Component B") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(ComponentB_Component.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Component C") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(ComponentC_Component.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Last observed states:") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Component A: ") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Component B: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(state.b)) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Component C: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showString))(state.c)) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ReadStates.create)) ])([ Halogen_HTML_Core.text("Check states now") ]) ]);
      };
      var initialState = {
