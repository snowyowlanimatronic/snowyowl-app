...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Toggle me!") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ToggleState.create)) ])([ Halogen_HTML_Core.text((function () {
              if (state) {
                  return "On";
              };
              return "Off";
      ...
      var $$eval = function (v) {
          if (v instanceof ToggleState) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof GetState) {
              return Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM));
          };
          throw new Error("Failed pattern match at ComponentA.Component line 39, column 3 - line 39, column 53: " + [ v.constructor.name ]);
      };
  ...
  exports["component"] = component;
})(PS["ComponentA.Component"] = PS["ComponentA.Component"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Current value:"), Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state)) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Increment.create)) ])([ Halogen_HTML_Core.text("Increment") ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at ComponentB.Component line 42, column 3 - line 42, column 53: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
  ...
  exports["component"] = component;
})(PS["ComponentB.Component"] = PS["ComponentB.Component"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("What do you have to say?") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(state), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(HandleInput.create)) ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at ComponentC.Component line 41, column 3 - line 41, column 53: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"]("Hello"),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  ...
  exports["component"] = component;
})(PS["ComponentC.Component"] = PS["ComponentC.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  var ComponentC_Component = PS["ComponentC.Component"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Monad_Eff_Exception = PS["Control.Monad.Eff.Exception"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var SubContainerA_Component_State = PS["SubContainerA.Component.State"];
  var ReadStates = (function () {
      function ReadStates(value0) {
          this.value0 = value0;
      };
      ReadStates.create = function (value0) {
          return new ReadStates(value0);
      };
      return ReadStates;
  })();
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Component A") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(ComponentA_Component.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Component B") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(ComponentB_Component.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Component C") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(ComponentC_Component.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Last observed states:") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Component A: ") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Component B: ") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Component C: ") ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ReadStates.create)) ])([ Halogen_HTML_Core.text("Check states now") ]) ]);
      };
      var initialState = {
          b: Data_Maybe.Nothing.value,
          c: Data_Maybe.Nothing.value
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
  ...
  exports["ui"] = ui;
})(PS["SubContainerA.Component"] = PS["SubContainerA.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var SubContainerB_Component_State = PS["SubContainerB.Component.State"];
  var ReadStates = (function () {
      function ReadStates(value0) {
          this.value0 = value0;
      };
  ...
  exports["ReadStates"] = ReadStates;
  exports["ui"] = ui;
})(PS["SubContainerB.Component"] = PS["SubContainerB.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var SubContainerC_Component_State = PS["SubContainerC.Component.State"];
  var ReadStates = (function () {
      function ReadStates(value0) {
          this.value0 = value0;
      };
  ...
  exports["ReadStates"] = ReadStates;
  exports["ui"] = ui;
})(PS["SubContainerC.Component"] = PS["SubContainerC.Component"] || {});
(function(exports) {
    "use strict";
  var CSS = PS["CSS"];
  var ComponentA_Component = PS["ComponentA.Component"];
  ...
  exports["ReadStates"] = ReadStates;
  exports["ui"] = ui;
})(PS["SubContainerD.Component"] = PS["SubContainerD.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  var Container_Component_State = PS["Container.Component.State"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Eff_Exception = PS["Control.Monad.Eff.Exception"];
  var Control_Monad_State = PS["Control.Monad.State"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var SubContainerA_Component = PS["SubContainerA.Component"];
  var SubContainerB_Component = PS["SubContainerB.Component"];
  var SubContainerC_Component = PS["SubContainerC.Component"];
  var SubContainerD_Component = PS["SubContainerD.Component"];        
  var Slot = (function () {
      function Slot() {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("SubContainer A") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(SubContainerA_Component.ui)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("SubContainer B") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(SubContainerB_Component.ui)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("SubContainer C") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(SubContainerC_Component.ui)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("SubContainer D") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp4)(Data_Unit.unit)(SubContainerD_Component.ui)(Data_Unit.unit)(Data_Void.absurd) ]) ]);
      };
      var initialState = {};
      var $$eval = function (v) {
...
})(PS["Container.Component"] = PS["Container.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var Profile_Component_State = PS["Profile.Component.State"];        
  var Slot = (function () {
      function Slot() {
  ...
  var ui = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Your Profile") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("what a nice profile!") ]) ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
  ...
  exports["eqSlot"] = eqSlot;
  exports["ordSlot"] = ordSlot;
})(PS["Profile.Component"] = PS["Profile.Component"] || {});
...
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var BigPrelude = PS["BigPrelude"];
  var Container_Component = PS["Container.Component"];
  var Control_Alt = PS["Control.Alt"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Apply = PS["Control.Apply"];
  var Control_Bind = PS["Control.Bind"];
  ...
  var Halogen_Query = PS["Halogen.Query"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Profile_Component = PS["Profile.Component"];
  ...
  var routing = (function () {
      ...
      var profile = Data_Functor.voidRight(Routing_Match.matchFunctor)(Profile.value)(route("profile"));
      var home = Data_Functor.voidRight(Routing_Match.matchFunctor)(Home.value)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)(""));
      var container = Data_Functor.voidRight(Routing_Match.matchFunctor)(Container.value)(route("container"));
      return Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(profile)(container))(home);
  })();
  var redirects = function (driver) {
      return function (v) {
          return function ($27) {
              return driver.query(Halogen_Query.action(Goto.create($27)));
          };
      };
  };
  var routeSignal = function (driver) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Routing.matchesAff(routing))(function (v) {
          return redirects(driver)(v.value0)(v.value1);
      });
  };
  var pathToProfile = Halogen_Component_ChildPath.cpL;
  var pathToContainer = Halogen_Component_ChildPath.cpR;
  var init = {
      currentPage: "Home"
  };
  var ui = (function () {
      var viewPage = function (v) {
          if (v === "Container") {
              return Halogen_HTML["slot'"](pathToContainer)(Container_Component.Slot.value)(Container_Component.ui)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (v === "Profile") {
              return Halogen_HTML["slot'"](pathToProfile)(Profile_Component.Slot.value)(Profile_Component.ui)(Data_Unit.unit)(Data_Void.absurd);
          };
      ...
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text(st.currentPage) ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(link)([ "Container", "Profile", "Home" ])), viewPage(st.currentPage) ]);
      };
      var $$eval = function (v) {
          if (v.value0 instanceof Profile) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $12.currentPage = "Profile";
                  return $12;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v.value0 instanceof Container) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $17 = {};
                  for (var $18 in v1) {
                  ...
                  $17.currentPage = "Container";
                  return $17;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v.value0 instanceof Home) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $22 = {};
                  for (var $23 in v1) {
          ...
          throw new Error("Failed pattern match at Router line 104, column 5 - line 104, column 73: " + [ v.constructor.name ]);
      };
  ...
  exports["pathToProfile"] = pathToProfile;
  exports["pathToContainer"] = pathToContainer;
  exports["ui"] = ui;
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Router.ui)(Data_Unit.unit)(v))(function (v1) {
