...
(function(exports) {
  ...
  var ComponentD_Component_State = PS["ComponentD.Component.State"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Monad_Eff_Exception = PS["Control.Monad.Eff.Exception"];
  ...
  exports["ui"] = ui;
})(PS["ComponentD.Component"] = PS["ComponentD.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  var ComponentB_Component = PS["ComponentB.Component"];
  var ComponentC_Component = PS["ComponentC.Component"];
  var ComponentD_Component = PS["ComponentD.Component"];
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Component B") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(ComponentB_Component.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Component C") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(ComponentC_Component.component)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Component D") ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(ComponentD_Component.ui)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Last observed states:") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Component B: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(state.b)) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Component C: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showString))(state.c)) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ReadStates.create)) ])([ Halogen_HTML_Core.text("Check states now") ]) ]);
      };
      var initialState = {
          b: Data_Maybe.Nothing.value,
          c: Data_Maybe.Nothing.value
      ...
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid))))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Halogen_Query.request(ComponentB_Component.GetCount.create)))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid))))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Halogen_Query.request(ComponentC_Component.GetValue.create)))(function (v2) {
